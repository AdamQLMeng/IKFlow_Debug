...
setup(
    ...
    extras_require={
        "dev": ["PyQt5", "black", "pylint", "wandb", "tabulate"]
    },
    install_requires=["klampt", "torch==2.0.1", "FrEIA==0.2", "more_itertools", "jrl==0.0.9",
                      "pynvml==11.5.0", "pandas", "qpth", "pytorch-lightning", 'tensorboard'],
    packages=["ikflow"],
